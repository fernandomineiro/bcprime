...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon"
        href="{{ $fav . '/' . (isset($company_favicon) && !empty($company_favicon) ? $company_favicon : 'favicon.png') . '?timestamp=' . time() }}"type="image/x-icon" />
    ...
    @if (!empty($adminSettings['cust_darklayout']) && $adminSettings['cust_darklayout'] == 'on')
        ...
        <div class="container">
            ...
            @endif
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <ul class="navbar-nav">
                        {{-- @dd($settings['feature_status'] == 'on') --}}
                        @if ($settings['home_title']=='on')
                            ...
                            @foreach (json_decode($settings['feature_of_features'], true) as $key => $value)
                                <div class="col-lg-4 col-sm-6 d-flex">
                                    <div class="card {{ $key == 0 ? 'bg-primary' : '' }}">
                                        <div class="card-body">
                                            @if (Storage::exists('/uploads/landing_page_image/' . $value['feature_logo']))
                        ...
                        <div class="col-xxl-3 col-sm-6 col-lg-4 ">
                            <div class="card   border {{ $key == 1 ? 'bg-primary' : 'bg-transparent' }}">
                                <div class="card-body text-center">
                                    @if (Storage::exists('/uploads/landing_page_image/' . $value['discover_logo']))
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <span
                                    class="mb-4 f-w-600 p-price">{{ \App\Models\Utility::getValByName('currency_symbol') . $value->price }}<small
                                ...
                                <ul class="list-unstyled my-3">
                                    <li>
                                        <div class="form-check text-start">
                                            {{-- <input class="form-check-input input-primary" disabled type="checkbox"
                                                id="customCheckc1" {{ $value->max_employee != 0 ? 'checked' : '' }}> --}}
                                            <label class="form-label" for="customCheckc1">{{ $value->max_employee }}
                                                {{ __('Employee') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            {{-- <input class="form-check-input input-primary" disabled type="checkbox"
                                                id="customCheckc1" {{ $value->max_client != 0 ? 'checked' : '' }}> --}}
                                            <label class="form-label" for="customCheckc1">{{ $value->max_client }}
                                                {{ __('Clients') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-label"
                                                for="customCheckc1">{{ $value->storage_limit }}{{ __('MB Storage') }}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                    ...
                                    <div class="card bg-dark shadow-none mb-0">
                                        <div class="card-body p-3">
                                            ...
                                            <p class="hljs-comment">
                                                {!! stripslashes($value->testimonials_description) !!}
                                            </p>
                                            <div class="d-flex  align-items-center ">
                                                <img src="@if (isset($value->testimonials_user_avtar)) {{ $logo . '/' . $value->testimonials_user_avtar }} @else {{ url('storage/avatars/avatar.png') }} @endif "
...
@if (!empty($adminSettings['enable_cookie']) && $adminSettings['enable_cookie'] == 'on')
